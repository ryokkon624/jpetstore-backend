 ...
 *
 * <p>{@code RegisterAttemptService#assertNotRateLimited} が、クライアントIPの直近窓内試行数が閾値を 超えている（{@code
 * t_register_attempt.lock_until}が有効）と判定した場合に投げる。{@code GlobalExceptionHandler}が429 Too Many
 * Requestsに正規化する。
 */
